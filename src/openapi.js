                     ...
                     schema: {
                        ...
                        properties: {
                           ...
                           callbackSecret: {
                              ...
                              minLength: 8,
                              maxLength: 256,
                              example: 'my-per-trx-secret',
                              description: "Signs THIS trx's webhooks (X-Signature) instead of the global WEBHOOK_SECRET. Never returned in responses.",
                           },
                     ...
                     examples: {
                        ...
                        full: {
                           ...
                           value: {
                              ...
                              trxId: 'ORDER-1042',
                              callbackUrl: 'https://shop.example.com/hook',
                              callbackSecret: 'my-per-trx-secret',
                              expireMinutes: 10,
                              metadata: { orderId: 1042 },
                           },
                        },
